...
import { perpusPerpusAdd } from "../../api/perpus/PerpusPerpusApi";
...
export default function PerpusPerpusForm({ form, payload, tableModalOnOk }) {
  const { Option } = Select;
  ...
  const fetchDatas = useCallback(async () => {
    try {
      ...
      await perpusPerpusAdd().then((response) => {
        dispatch({
          type: "complete",
